...
#define CMDPOS_ASSOCREQ_DEV_VER	CMDPOS_ASSOC_GUID + 8
#define CMDPOS_ASSOCREQ_SYSSTAT CMDPOS_ASSOCREQ_DEV_VER + 1
...
#define CMDPOS_ASSOCCHK_DEV		CMDPOS_ASSOC_GUID + 8
#define CMDPOS_ASSOCCHK_BATT	CMDPOS_ASSOCCHK_DEV + 1
