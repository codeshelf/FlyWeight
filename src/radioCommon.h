...
//#define MASTER_TPM2_RATE		0x873
	...
	#define SETUP_SPKR_CONTROL		PTBDD |= 0b00001000;
	#define SPKR_AMP_OFF			PTBD  |= 0b00001000;
	#define SPKR_AMP_ON				PTBD  &= 0b11110111;
	#define SETUP_MIC_CONTROL		PTBDD |= 0b10000000;
	#define MIC_AMP_OFF				PTBD  &= 0b01111111;
	#define MIC_AMP_ON				PTBD  |= 0b10000000;
	#define ATD_ON					ATD1C_ATDPU = 1; ATD1SC_ATDIE = 1;
