...
volatile KBISCSTR _KBISC;                                  /* KBI Status and Control; 0x00000016 */
volatile KBIPESTR _KBIPE;                                  /* KBI Pin Enable Register; 0x00000017 */
...
volatile ATDCSTR _ATDC;                                    /* ATD Control Register; 0x00000050 */
volatile ATDSCSTR _ATDSC;                                  /* ATD Status and Control Register; 0x00000051 */
volatile ATDPESTR _ATDPE;                                  /* ATD Pin Enable; 0x00000054 */
volatile IICASTR _IICA;                                    /* IIC Address Register; 0x00000058 */
volatile IICFSTR _IICF;                                    /* IIC Frequency Divider Register; 0x00000059 */
volatile IICCSTR _IICC;                                    /* IIC Control Register; 0x0000005A */
...
volatile ATDRSTR _ATDR;                                    /* ATD Result Data; 0x00000052 */
